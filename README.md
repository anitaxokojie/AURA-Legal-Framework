...
**Status:** Completed (Full Factorial Benchmark)
...
3.  **Optimizes** the query using a **$2^n$ Exhaustive Search** algorithm against ground-truth data (NIST QRELs) to filter out hallucinations and noise.
...
The system acts as a "Simulated Attorney." It tests every possible boolean combination ($2^n$) of the extracted themes against the ground truth to mathematically determine which themes carry the strongest relevance signal.
